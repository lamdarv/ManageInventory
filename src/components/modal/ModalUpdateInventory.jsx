...
const ModalUpdateInventory = ({ isOpen, onRequestClose, postId }) => {
  ...
  const getPostById = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        console.error("Failed to get post by id:", response.statusText);
      }
    } catch (error) {}
  };
  ...
  const updatePost = async (event) => {
    ...
    try {
      ...
      if (response.status === 200) {
        window.alert('Inventaris berhasil diperbarui!');
        onRequestClose();
        window.location.reload()
      } else {
        console.error("Failed to update posts:", response.statusText);
      }
    } catch (error) {
      console.error(error);
    }
  ...
  const options = [
    ...
    {
      value: "201524049 - Lamda Richo Vanjaya Sumaryadi",
      label: "201524049 - Lamda Richo Vanjaya Sumaryadi",
    },
    {
      value: "201524045 - Fiora Berliana Putri",
      label: "201524045 - Fiora Berliana Putri",
    },
    {
      value: "201524055 - Nauval Ozora Mahadri",
      label: "201524055 - Nauval Ozora Mahadri",
    },
    {
      value: "201524060 - Vani Anjelina Rangkuti",
      label: "201524060 - Vani Anjelina Rangkuti",
    },
    {
      value: "201524037 - Alvin Mulia Putra",
      label: "201524037 - Alvin Mulia Putra",
    },
    {
      value: "201524043 - Arief Nur Rachman",
      label: "201524043 - Arief Nur Rachman",
    },
    { value: "201524056 - Novian Afiq", label: "201524056 - Novian Afiq" },
    {
      value: "201524048 - Halimatussadiyah",
      label: "201524048 - Halimatussadiyah",
    },
    {
      value: "201524052 - Muhammad Rifqi Hidayatullah",
      label: "201524052 - Muhammad Rifqi Hidayatullah",
    },
    {
      value: "201524042 - Satria Akhmad Ihsani",
      label: "201524042 - Satria Akhmad Ihsani",
    },
  ];
                ...
                <div className="mb-6 w-96">
                  ...
                  <Select
                    ...
                    onChange={(selectedOptions) =>
                      setPeminjam(selectedOptions.map((option) => option.value))
                    }
